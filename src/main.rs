...
use args::Args;
use image::{
    imageops::FilterType::Triangle, io::Reader, save_buffer_with_format, ColorType, DynamicImage,
...
impl FloatingImage {
    fn new(width: u32, height: u32, name: String) -> Self {
        let buff_cap = height * width * 4;
        let buffer = Vec::with_capacity(buff_cap.try_into().unwrap());
        FloatingImage {
            width,
            height,
            data: buffer,
